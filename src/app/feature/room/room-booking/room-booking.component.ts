  ...
  ngOnInit(): void {
    ...
    this.bookingForm = this.fb.group({
      ...
      userId: [this.currentUser.userId],
        ...
        paypalEmail: [''],
        cardNumber: ['', [Validators.required,validateCardNumber]],
        cardHolderName: [''],
        cardExpiryDate: ['',[Validators.required,expiryDateValidator]],
        cardSecurityCode: ['',[Validators.required,securityCodeValidator]],
  ...
  booking() {
    this.bookingService.bookRoom(this.bookingForm.value).subscribe({
      next: (response) => {
        ...
        this.router.navigate(['/booking-received'],{state: { response }}); //reference number
      },
      error: (error) => {
